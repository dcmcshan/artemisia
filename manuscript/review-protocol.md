...
The first seven manual title/abstract tranches are archived in `manual-screening-decisions.csv`. They contain 195 high-priority decisions with bounded evidence scopes and rationale. The remaining 1,192 priority records are still pending manual review; these tranches are not an exhaustive inclusion set.
