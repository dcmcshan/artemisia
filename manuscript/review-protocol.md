...
The archived manual title/abstract decisions are stored in `manual-screening-decisions.csv`. They contain 256 high-priority decisions with bounded evidence scopes and rationale. The remaining 1,131 priority records are still pending manual review; this log is not an exhaustive inclusion set.
