...
The first nine manual title/abstract tranches are archived in `manual-screening-decisions.csv`. They contain 235 high-priority decisions with bounded evidence scopes and rationale. The remaining 1,152 priority records are still pending manual review; these tranches are not an exhaustive inclusion set.
