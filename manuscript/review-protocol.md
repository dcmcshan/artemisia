...
The first manual title/abstract tranche is archived in `manual-screening-decisions.csv`. It contains 58 high-priority decisions with bounded evidence scopes and rationale. The remaining queue is still pending manual review; this tranche is not an exhaustive inclusion set.
