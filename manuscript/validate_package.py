...
def main():
    ...
    assert len(matrix) == 51 and len(antiparasitic) == 14 and len(chemotypes) == 10 and len(safety) == 4 and len(manual) == 235 and len(supplementary) == 25 and len(claims) == 12 and not matrix_missing
