...
def main():
    ...
    assert len(verification_ids) == len(set(verification_ids)) == 60
    ...
    assert len(matrix) == 540 and len(antiparasitic) == 127 and len(interactions) == 19 and len(chemotypes) == 10 and len(safety) == 21 and len(full_text_queue) == 108 and len(manual) == 1408 and len(manual_pmids) == len(manual) and len(manual_pmids & queue_pmids) == 1387 and len(supplementary) == 179 and len(claims) == 373 and not matrix_missing
