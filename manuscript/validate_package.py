...
def main():
    ...
    assert len(matrix) == 38 and len(antiparasitic) == 14 and len(chemotypes) == 10 and len(safety) == 4 and len(manual) == 131 and len(supplementary) == 25 and not matrix_missing
