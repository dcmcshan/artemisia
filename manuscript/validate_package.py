...
def main():
    ...
    assert len(verification_ids) == len(set(verification_ids)) == 61
    ...
    assert len(matrix) == 541 and len(antiparasitic) == 128 and len(interactions) == 19 and len(chemotypes) == 10 and len(safety) == 21 and len(full_text_queue) == 109 and len(manual) == 1408 and len(manual_pmids) == len(manual) and len(manual_pmids & queue_pmids) == 1387 and len(supplementary) == 179 and len(claims) == 374 and not matrix_missing
