...
- `full-text-verification.csv` — four full-text extraction tranches: 27 open-access sources covering 34 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
