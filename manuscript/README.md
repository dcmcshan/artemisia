...
- `full-text-verification.csv` — thirty-nine full-text extraction tranches: 79 sources covering 94 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
