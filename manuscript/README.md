...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 144-source manuscript, including the focused malaria/wormwood evidence table and both regenerated figures.
...
- `manual-screening-decisions.csv` — 328-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
