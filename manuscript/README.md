...
- `manual-screening-decisions.csv` — first 16-record manual title/abstract screening tranche with bounded decisions and rationale; the full queue remains open.
