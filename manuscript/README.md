...
- `manual-screening-decisions.csv` — first 58-record manual title/abstract screening tranche with bounded decisions and rationale; the full queue remains open.
