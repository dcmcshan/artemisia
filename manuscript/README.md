...
- `full-text-verification.csv` — ten full-text extraction tranches: 42 sources (39 open-access and 3 publisher-full-text records) covering 51 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
