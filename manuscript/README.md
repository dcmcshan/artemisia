...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 302-source manuscript, including the focused malaria/wormwood evidence table, comparative-genomics table, and both regenerated figures.
...
- `manual-screening-decisions.csv` — 480-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
