...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 262-source manuscript, including the focused malaria/wormwood evidence table, comparative-genomics table, and both regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 248-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
...
- `manual-screening-decisions.csv` — 436-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
