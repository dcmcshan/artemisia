...
- `full-text-verification.csv` — thirty-six full-text extraction tranches: 75 sources covering 88 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
