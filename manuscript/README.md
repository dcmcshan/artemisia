...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 324-source manuscript with 325 evidence records, including the focused malaria/wormwood evidence table, comparative-genomics table, vector-control evidence, and regenerated figures.
...
- `antiparasitic-evidence.csv` — 77 quantitative, stage-aware parasite/vector assay records with host-control and translation boundaries.
...
- `manual-screening-decisions.csv` — 504-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
