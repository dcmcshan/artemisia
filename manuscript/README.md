...
- `artemisia-terpene-review-draft.pdf` — visually verified 30-page rendering of the current 286-source manuscript, including the focused malaria/wormwood evidence table, comparative-genomics table, and both regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 281-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
...
- `supplementary-compound-specimen.csv` — 50 specimen-/tissue-/preparation-level compound records, including explicit non-terpene comparators.
...
- `manual-screening-decisions.csv` — 461-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
