...
- `full-text-verification.csv` — twenty-nine full-text extraction tranches: 63 sources (54 open-access, 6 publisher-full-text, and 3 public full-article-PDF mirror records) covering 73 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
