...
- `full-text-verification.csv` — thirty-five full-text extraction tranches: 74 sources (63 open-access, 6 publisher-full-text, and 4 public full-article-PDF mirror records) covering 87 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
