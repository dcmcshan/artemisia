...
- `full-text-verification.csv` — six full-text extraction tranches: 37 open-access sources covering 45 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
