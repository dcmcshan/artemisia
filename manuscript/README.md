...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 339-source manuscript with 341 evidence records, including the focused malaria/wormwood evidence table, comparative-genomics table, vector-control evidence, and regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 325-record specimen-, compound-, pathway-, genome-, review-, and assay-level evidence table.
...
- `supplementary-compound-specimen.csv` — 64 specimen-/tissue-/preparation-level compound records, including explicit non-terpene comparators.
- `antiparasitic-evidence.csv` — 86 quantitative, stage-aware parasite/vector assay records with host-control and translation boundaries.
...
- `manual-screening-decisions.csv` — 520-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
