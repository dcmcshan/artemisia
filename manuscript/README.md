...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 284-source manuscript, including the focused malaria/wormwood evidence table, comparative-genomics table, and both regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 270-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
...
- `supplementary-compound-specimen.csv` — 48 specimen-/tissue-/preparation-level compound records, including explicit non-terpene comparators.
