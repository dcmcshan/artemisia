...
- `full-text-verification.csv` — five full-text extraction tranches: 35 open-access sources covering 43 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
