...
- `full-text-verification.csv` — forty-one full-text extraction tranches: 81 sources covering 96 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
