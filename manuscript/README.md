...
- `full-text-verification.csv` — twenty-six full-text extraction tranches: 60 sources (52 open-access, 5 publisher-full-text, and 3 public full-article-PDF mirror records) covering 70 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
