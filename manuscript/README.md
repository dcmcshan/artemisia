...
- `evidence-matrix.csv` — 56-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
...
- `manual-screening-decisions.csv` — 315-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
