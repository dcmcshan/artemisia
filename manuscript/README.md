...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 420-source manuscript with 422 evidence records, including the focused malaria/wormwood evidence table, comparative-genomics table, vector-control evidence, and regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 422-record specimen-, compound-, pathway-, genome-, review-, and assay-level evidence table.
...
- `supplementary-compound-specimen.csv` — 90 specimen-/tissue-/preparation-level compound records, including explicit non-terpene comparators.
...
- `manual-screening-decisions.csv` — 600-record manual title/abstract screening log with bounded decisions and rationale; the full queue remains open.
