...
- `full-text-verification.csv` — thirty-two full-text extraction tranches: 66 sources (56 open-access, 6 publisher-full-text, and 3 public full-article-PDF mirror records) covering 76 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
