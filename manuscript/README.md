...
- `full-text-verification.csv` — thirty-four full-text extraction tranches: 69 sources (58 open-access, 6 publisher-full-text, and 4 public full-article-PDF mirror records) covering 79 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
