...
- `artemisia-terpene-review-draft.pdf` — visually verified rendering of the current 155-source manuscript, including the focused malaria/wormwood evidence table and both regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 140-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
