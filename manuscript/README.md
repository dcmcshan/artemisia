...
- `full-text-verification.csv` — seventeen full-text extraction tranches: 50 sources (47 open-access and 3 publisher-full-text records) covering 59 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
