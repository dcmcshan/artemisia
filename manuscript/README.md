...
- `full-text-verification.csv` — thirty-three full-text extraction tranches: 67 sources (56 open-access, 6 publisher-full-text, and 4 public full-article-PDF mirror records) covering 77 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
