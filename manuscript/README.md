...
- `full-text-verification.csv` — twenty-five full-text extraction tranches: 59 sources (52 open-access, 5 publisher-full-text, and 2 public full-article-PDF mirror records) covering 69 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
