...
- `full-text-verification.csv` — three full-text extraction tranches: 22 open-access sources covering 28 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
