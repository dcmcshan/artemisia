...
- `full-text-verification.csv` — fourteen full-text extraction tranches: 47 sources (44 open-access and 3 publisher-full-text records) covering 56 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
