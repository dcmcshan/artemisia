...
- `full-text-verification.csv` — fifty full-text extraction records: 90 sources covering 105 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates; the latest records retain the *A. sieberi* seasonal-artemisinin/*Eimeria* study, *A. indica* electronic-reprint mixture/host-control caveat, *A. campestris* inaccessible-tables, *A. scoparia* IC50-unit, *A. absinthium*/*H. contortus* indexed-text, two 2026 *A. annua* indexed-study, 2025 *A. cina* ewe-trial, and low-dose *A. annua* coccidiosis caveats.
