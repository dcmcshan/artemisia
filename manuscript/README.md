...
- `full-text-verification.csv` — thirty-one full-text extraction tranches: 65 sources (56 open-access, 6 publisher-full-text, and 3 public full-article-PDF mirror records) covering 75 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
