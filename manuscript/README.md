...
- `full-text-verification.csv` — twelve full-text extraction tranches: 45 sources (42 open-access and 3 publisher-full-text records) covering 54 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
