...
- `full-text-verification.csv` — eleven full-text extraction tranches: 44 sources (41 open-access and 3 publisher-full-text records) covering 53 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
