...
- `artemisia-terpene-review-draft.pdf` — visually verified 15-page rendering of the current 136-source manuscript, including the focused malaria/wormwood evidence table and both regenerated figures.
- `review-protocol.md` — inclusion, extraction, quality-assessment, and synthesis protocol.
- `evidence-matrix.csv` — 120-record specimen-, compound-, pathway-, genome-, and assay-level evidence table.
