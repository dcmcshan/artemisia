...
- `full-text-verification.csv` — twenty-eight full-text extraction tranches: 62 sources (54 open-access, 5 publisher-full-text, and 3 public full-article-PDF mirror records) covering 72 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
