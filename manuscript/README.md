...
- `full-text-verification.csv` — first full-text extraction tranche: 9 open-access sources covering 12 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
