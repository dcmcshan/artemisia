...
- `full-text-verification.csv` — forty full-text extraction tranches: 80 sources covering 95 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
