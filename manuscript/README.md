...
- `full-text-verification.csv` — eighteen full-text extraction tranches: 51 sources (47 open-access and 4 publisher-full-text records) covering 60 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
