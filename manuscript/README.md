...
- `full-text-verification.csv` — thirty full-text extraction tranches: 64 sources (55 open-access, 6 publisher-full-text, and 3 public full-article-PDF mirror records) covering 74 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
