...
- `full-text-verification.csv` — two full-text extraction tranches: 18 open-access sources covering 23 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
