...
- `full-text-verification.csv` — twenty-four full-text extraction tranches: 58 sources (52 open-access, 4 publisher-full-text, and 2 public full-article-PDF mirror records) covering 67 evidence rows, with preparation-specific findings and explicit unresolved quantitative-eligibility gates.
