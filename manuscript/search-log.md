...
A focused manual-screening follow-up added three already-registered central records: the comparative *A. argyi* TPS/ADS genomics study, the resistant-*P. falciparum* *A. afra/A. annua* aqueous-extract study, and the *A. annua* diterpene-synthase/trichome perturbation study. The bounded screening tranche now contains 337 decisions; 1,051 records remain pending in the archived 1,387-record triage queue, because one manually screened current-literature record was outside that queue. This remains an open living-review queue.
