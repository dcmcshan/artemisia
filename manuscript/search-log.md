...
A focused manual-screening follow-up added three already-registered central records: the comparative *A. argyi* TPS/ADS genomics study, the resistant-*P. falciparum* *A. afra/A. annua* aqueous-extract study, and the *A. annua* diterpene-synthase/trichome perturbation study. The bounded screening tranche now contains 337 decisions, leaving 1,050 priority records pending; this remains an open living-review queue.
