...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>39 sources verified; 66 open]
...
| Full-text verification tranches | 39 of 105 sources; 47 of 124 evidence rows | `full-text-verification.csv` | eighth tranche complete; 66 sources open |
