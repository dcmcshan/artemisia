...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>90 sources verified; 22 open]
...
| Full-text verification records | 90 of 112 sources; 105 of 131 evidence rows | `full-text-verification.csv` | fiftieth record complete; 22 sources open |
