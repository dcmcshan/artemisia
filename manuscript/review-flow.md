...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>84 sources verified; 26 open]
...
| Full-text verification records | 84 of 110 sources; 99 of 129 evidence rows | `full-text-verification.csv` | forty-fourth record complete; 26 sources open |
