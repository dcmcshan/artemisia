...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>61 sources verified; 48 open]
...
| Full-text verification tranches | 61 of 109 sources; 71 of 128 evidence rows | `full-text-verification.csv` | twenty-seventh tranche complete; 48 sources open |
