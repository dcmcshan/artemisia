...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>62 sources verified; 47 open]
...
| Full-text verification tranches | 62 of 109 sources; 72 of 128 evidence rows | `full-text-verification.csv` | twenty-eighth tranche complete; 47 sources open |
