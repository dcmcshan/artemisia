...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>56 sources verified; 52 open]
...
| Full-text verification tranches | 56 of 108 sources; 65 of 127 evidence rows | `full-text-verification.csv` | twenty-second tranche complete; 52 sources open |
