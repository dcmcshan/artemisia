...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>37 sources verified; 67 open]
...
| Full-text verification tranches | 37 of 104 sources; 45 of 123 evidence rows | `full-text-verification.csv` | sixth tranche complete; 67 sources open |
