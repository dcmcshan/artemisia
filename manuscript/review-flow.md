...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>41 sources verified; 64 open]
...
| Full-text verification tranches | 41 of 105 sources; 49 of 124 evidence rows | `full-text-verification.csv` | ninth tranche complete; 64 sources open |
