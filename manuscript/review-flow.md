...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>103 sources verified; 11 open]
...
| Full-text verification records | 103 of 114 sources; 118 of 133 evidence rows | `full-text-verification.csv` | latest verification records complete; 11 sources open |
