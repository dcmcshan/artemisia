...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>87 sources verified; 24 open]
...
| Full-text verification records | 87 of 111 sources; 102 of 130 evidence rows | `full-text-verification.csv` | forty-seventh record complete; 24 sources open |
