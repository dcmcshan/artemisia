...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>38 sources verified; 66 open]
...
| Full-text verification tranches | 38 of 104 sources; 46 of 123 evidence rows | `full-text-verification.csv` | seventh tranche complete; 66 sources open |
