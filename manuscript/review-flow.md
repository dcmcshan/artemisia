...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>110 sources verified; 4 open]
...
| Full-text verification records | 110 of 114 sources; 126 of 133 evidence rows | `full-text-verification.csv` | latest verification records complete; 4 sources open |
