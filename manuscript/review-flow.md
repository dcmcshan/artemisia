...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>89 sources verified; 23 open]
...
| Full-text verification records | 89 of 112 sources; 104 of 131 evidence rows | `full-text-verification.csv` | forty-ninth record complete; 23 sources open |
