...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>9 sources verified; 95 open]
...
| Full-text verification tranche | 9 of 104 sources; 12 of 123 evidence rows | `full-text-verification.csv` | first tranche complete; 95 sources open |
