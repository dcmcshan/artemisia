...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>50 sources verified; 56 open]
...
| Full-text verification tranches | 50 of 106 sources; 59 of 125 evidence rows | `full-text-verification.csv` | seventeenth tranche complete; 56 sources open |
