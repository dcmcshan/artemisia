...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>88 sources verified; 24 open]
...
| Full-text verification records | 88 of 112 sources; 103 of 131 evidence rows | `full-text-verification.csv` | forty-eighth record complete; 24 sources open |
