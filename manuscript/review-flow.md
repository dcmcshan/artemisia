...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>80 sources verified; 30 open]
...
| Full-text verification tranches | 80 of 110 sources; 95 of 129 evidence rows | `full-text-verification.csv` | fortieth tranche complete; 30 sources open |
