...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>51 sources verified; 55 open]
...
| Full-text verification tranches | 51 of 106 sources; 60 of 125 evidence rows | `full-text-verification.csv` | eighteenth tranche complete; 55 sources open |
