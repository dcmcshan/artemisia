...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>67 sources verified; 42 open]
...
| Full-text verification tranches | 67 of 109 sources; 77 of 128 evidence rows | `full-text-verification.csv` | thirty-third tranche complete; 42 sources open |
