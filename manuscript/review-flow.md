...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>42 sources verified; 63 open]
...
| Full-text verification tranches | 42 of 105 sources; 51 of 124 evidence rows | `full-text-verification.csv` | tenth tranche complete; 63 sources open |
