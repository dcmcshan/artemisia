...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>44 sources verified; 61 open]
...
| Full-text verification tranches | 44 of 105 sources; 53 of 124 evidence rows | `full-text-verification.csv` | eleventh tranche complete; 61 sources open |
