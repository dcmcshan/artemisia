...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>66 sources verified; 43 open]
...
| Full-text verification tranches | 66 of 109 sources; 76 of 128 evidence rows | `full-text-verification.csv` | thirty-second tranche complete; 43 sources open |
