...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>48 sources verified; 57 open]
...
| Full-text verification tranches | 48 of 105 sources; 57 of 124 evidence rows | `full-text-verification.csv` | fifteenth tranche complete; 57 sources open |
