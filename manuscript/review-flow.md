...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>35 sources verified; 69 open]
...
| Full-text verification tranches | 35 of 104 sources; 43 of 123 evidence rows | `full-text-verification.csv` | fifth tranche complete; 69 sources open |
