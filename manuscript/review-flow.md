...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>82 sources verified; 28 open]
...
| Full-text verification tranches | 82 of 110 sources; 97 of 129 evidence rows | `full-text-verification.csv` | forty-second tranche complete; 28 sources open |
