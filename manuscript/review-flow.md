...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>93 sources verified; 20 open]
...
| Full-text verification records | 93 of 113 sources; 108 of 132 evidence rows | `full-text-verification.csv` | fifty-third record complete; 20 sources open |
