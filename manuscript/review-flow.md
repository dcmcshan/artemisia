...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>75 sources verified; 34 open]
...
| Full-text verification tranches | 75 of 109 sources; 88 of 128 evidence rows | `full-text-verification.csv` | thirty-sixth tranche complete; 34 sources open |
