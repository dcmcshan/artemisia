...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>86 sources verified; 24 open]
...
| Full-text verification records | 86 of 110 sources; 101 of 129 evidence rows | `full-text-verification.csv` | forty-sixth record complete; 24 sources open |
