...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>53 sources verified; 53 open]
...
| Full-text verification tranches | 53 of 106 sources; 62 of 125 evidence rows | `full-text-verification.csv` | twentieth tranche complete; 53 sources open |
