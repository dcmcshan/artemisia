...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>97 sources verified; 17 open]
...
| Full-text verification records | 97 of 114 sources; 112 of 133 evidence rows | `full-text-verification.csv` | fifty-seventh record complete; 17 sources open |
