...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>65 sources verified; 44 open]
...
| Full-text verification tranches | 65 of 109 sources; 75 of 128 evidence rows | `full-text-verification.csv` | thirty-first tranche complete; 44 sources open |
