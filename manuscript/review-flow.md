...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>74 sources verified; 35 open]
...
| Full-text verification tranches | 74 of 109 sources; 87 of 128 evidence rows | `full-text-verification.csv` | thirty-fifth tranche complete; 35 sources open |
