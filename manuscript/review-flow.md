...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>69 sources verified; 40 open]
...
| Full-text verification tranches | 69 of 109 sources; 79 of 128 evidence rows | `full-text-verification.csv` | thirty-fourth tranche complete; 40 sources open |
