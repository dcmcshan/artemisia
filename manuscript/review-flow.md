...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>96 sources verified; 18 open]
...
| Full-text verification records | 96 of 114 sources; 111 of 133 evidence rows | `full-text-verification.csv` | fifty-sixth record complete; 18 sources open |
