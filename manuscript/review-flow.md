...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>81 sources verified; 29 open]
...
| Full-text verification tranches | 81 of 110 sources; 96 of 129 evidence rows | `full-text-verification.csv` | forty-first tranche complete; 29 sources open |
