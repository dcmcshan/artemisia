...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>58 sources verified; 50 open]
...
| Full-text verification tranches | 58 of 108 sources; 67 of 127 evidence rows | `full-text-verification.csv` | twenty-fourth tranche complete; 50 sources open |
