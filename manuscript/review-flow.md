...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>57 sources verified; 51 open]
...
| Full-text verification tranches | 57 of 108 sources; 66 of 127 evidence rows | `full-text-verification.csv` | twenty-third tranche complete; 51 sources open |
