...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>59 sources verified; 49 open]
...
| Full-text verification tranches | 59 of 108 sources; 69 of 127 evidence rows | `full-text-verification.csv` | twenty-fifth tranche complete; 49 sources open |
