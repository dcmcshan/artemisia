...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>60 sources verified; 48 open]
...
| Full-text verification tranches | 60 of 108 sources; 70 of 127 evidence rows | `full-text-verification.csv` | twenty-sixth tranche complete; 48 sources open |
