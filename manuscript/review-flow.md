...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>79 sources verified; 31 open]
...
| Full-text verification tranches | 79 of 110 sources; 94 of 129 evidence rows | `full-text-verification.csv` | thirty-ninth tranche complete; 31 sources open |
