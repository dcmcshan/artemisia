...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>47 sources verified; 58 open]
...
| Full-text verification tranches | 47 of 105 sources; 56 of 124 evidence rows | `full-text-verification.csv` | fourteenth tranche complete; 58 sources open |
