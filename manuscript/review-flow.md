...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>83 sources verified; 27 open]
...
| Full-text verification records | 83 of 110 sources; 98 of 129 evidence rows | `full-text-verification.csv` | forty-third record complete; 27 sources open |
