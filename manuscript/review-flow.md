...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>49 sources verified; 57 open]
...
| Full-text verification tranches | 49 of 106 sources; 58 of 125 evidence rows | `full-text-verification.csv` | sixteenth tranche complete; 57 sources open |
