...
flowchart TB
  ...
  N --> M
  M --> F[Full-text verification and extraction<br/>52 sources verified; 54 open]
...
| Full-text verification tranches | 52 of 106 sources; 61 of 125 evidence rows | `full-text-verification.csv` | nineteenth tranche complete; 54 sources open |
