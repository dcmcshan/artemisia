...
- [x] Add a reproducible provisional appraisal of all 130 antiparasitic records with explicit chemistry, phenotype, host-control, mechanism, and translation dimensions.
...
- [x] Complete and archive forty-seven full-text verification records for 87 sources (102 evidence rows), while retaining final eligibility and quantitative pooling as open gates.
