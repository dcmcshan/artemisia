...
- [x] Mono- and sesquiterpene classes reviewed.
- [x] Diterpene and triterpene coverage included with an explicit evidence limitation.
- [x] Sesquiterpene-lactone chemistry, artemisinin, and analytical constraints included.
- [x] Biosynthetic pathways and gene-family evolution addressed.
- [x] Chemotype, tissue, phenology, environment, extraction, and analytical variation addressed.
...
- [x] Add a reproducible provisional appraisal of all 126 antiparasitic records with explicit chemistry, phenotype, host-control, mechanism, and translation dimensions.
...
- [x] Complete and archive twenty-one full-text verification tranches for 54 sources (49 open-access, 4 publisher-full-text, and 1 public full-article-PDF mirror record; 63 evidence rows), while retaining final eligibility and quantitative pooling as open gates.
