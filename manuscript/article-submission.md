...
To make this critical comparison reproducible, we applied the provisional non-compensatory rubric in `evidence-appraisal-protocol.md` to all 123 antiparasitic records. Nineteen records had defined or purified chemistry, 36 had a profiled mixture, and 68 retained crude or unresolved attribution; 83 reported direct in-vitro parasite/vector assays, 37 included an in-vivo or organismal endpoint, and three were surrogate hemozoin assays. Explicit host/selectivity controls were present in 17 records, partial controls in 23, and absent or unresolved in 83. Only three records reached the E4/E5 functional-target-class level through the linked interaction map; 22 were hypothesis/stage-mechanism level and 98 were phenotype-only or unresolved. The overall appraisal therefore yielded 22 B-level characterized phenotypes and 101 C-level phenotypes with unresolved attribution; no record met the deliberately strict A tier. This is a limitation of evidence resolution, not evidence that the preparations lack activity. Row-level judgments and their rule basis are archived in `evidence-appraisal.csv`.
